...
# Lasso Regression - Performs inbuilt variable selection -- Algorithm
#
##############################################################################################
...
stime_SO2 <- proc.time()
model_SO2 <- cv.glmnet(dep_var_SO2, ind_var_SO2, alpha=1, lambda = lambdasSO2)
etime_SO2 <- proc.time() - stime_SO2
print(etime_SO2)

stime_NO2 <- proc.time()
model_NO2 <- cv.glmnet(dep_var_NO2, ind_var_NO2, alpha=1, lambda = lambdasNO2)
...
if(predict_busroute_airquality == "FALSE"){
	...
	### Print pdf for NO2
	pdf("/home/iotcloud/shaju/workspace/Eclipseworkspace/EnergyAnalyzer/tests/mobility/Results/Lasso_NO2Plot.pdf",width=8,height=5)
	print(plotNO2)
	dev.off()
	...
	### Print pdf for SO2
	pdf("/home/iotcloud/shaju/workspace/Eclipseworkspace/EnergyAnalyzer/tests/mobility/Results/Lasso_SO2Plot.pdf",width=8,height=5)
	print(plotSO2)
	dev.off()
